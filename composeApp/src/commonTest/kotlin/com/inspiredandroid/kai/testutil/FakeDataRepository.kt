...
class FakeDataRepository : DataRepository {
    ...
    override val modelBenchmarks: StateFlow<List<ModelBenchmark>> = MutableStateFlow(emptyList())
    override fun getModelBenchmarks(): List<ModelBenchmark> = emptyList()
    override fun upsertModelBenchmark(benchmark: ModelBenchmark) {}
    override fun clearModelBenchmarks() {}

    override fun getOpenCodeTerminalThinking(): Boolean = false
    override fun setOpenCodeTerminalThinking(enabled: Boolean) {}
    override fun getOpenCodeTerminalMode(): String = "build"
