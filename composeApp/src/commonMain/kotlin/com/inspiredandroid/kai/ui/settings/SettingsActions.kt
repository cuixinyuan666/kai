...
data class SettingsActions(
    ...
    val onToggleServiceSortReversed: (Boolean) -> Unit,
    val onToggleDefaultInteractiveMode: (Boolean) -> Unit,
    // 模型基准测试（一键测试所有大模型）
    val onRunModelBenchmarks: () -> Unit,
    val onCancelModelBenchmarks: () -> Unit,
    val onClearModelBenchmarks: () -> Unit,
    // OpenCode 终端 thinking/plan/build
    val onToggleOpenCodeTerminalThinking: (Boolean) -> Unit,
    val onChangeOpenCodeTerminalMode: (String) -> Unit,
    ...
    companion object {
        val NoOp = SettingsActions(
            ...
            onToggleServiceSortReversed = {},
            onToggleDefaultInteractiveMode = {},
            onRunModelBenchmarks = {},
            onCancelModelBenchmarks = {},
            onClearModelBenchmarks = {},
            onToggleOpenCodeTerminalThinking = {},
            onChangeOpenCodeTerminalMode = {},
            onChangeUiScale = {},
